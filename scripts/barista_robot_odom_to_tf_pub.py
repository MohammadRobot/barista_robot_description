...
class RobotToWorldTF(Node):

    def __init__(self, robot_name="barista_robot", robot_base_frame="base_link"):
        super().__init__(robot_name +'_world_to_tf_broadcaster_node')
        ...
        self.get_logger().info(self.robot_name +"_world_to_tf_broadcaster_node ready!")
...
def main(args=None):
    ...
    rclpy.init()
    world_to_tf_broadcaste = RobotToWorldTF()
    rclpy.spin(world_to_tf_broadcaste)
